"""
Django settings for prj_duoread project.
...
SECRET_KEY = '^61(ssm0y8bm*m(8cautqg3_q!ha@x+y)=w_j#(j3_y%ibf_m6'
...
WSGI_APPLICATION = 'prj_duoread.wsgi.application'
